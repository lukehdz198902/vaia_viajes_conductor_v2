...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final List<PermisoDef> _permisos = PermissionService.conductor();
  int _pagina = 0;
        ...
        children: [
          ...
          Text(
            _biometriaDisponible
                ...
                : 'Tu dispositivo no tiene biometria configurada. Podras activarla mas tarde desde Configuracion.',
            textAlign: TextAlign.center,
            style: const TextStyle(fontSize: 14, color: VaiaColors.textSecondary, height: 1.4),
          ),
          const SizedBox(height: 22),
          Container(
            ...
            child: Column(
              children: [
                ...
                _puntoBiometria('Puedes desactivarla en Configuracion'),
              ],
            ),
          ),
          const Spacer(),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const Center(
            child: Icon(Icons.gavel_rounded, size: 46, color: VaiaColors.primary),
          ),
          ...
          const SizedBox(height: 8),
          const Text('Para usar Vaia Conductor debes aceptar nuestras politicas.',
              textAlign: TextAlign.center,
